		...
		this.template = [
			...
			},
			{
				...
				submenu: [
					...
					// 	]
					// },
					{ label: 'Export Open Windows As PNGs', accelerator: 'CommandOrControl+P', click: () => util.captureIcons() },
					{ label: 'Create Icons From PNGs', accelerator: 'CommandOrControl+I', click: () => util.createIcons() },
					{ label: 'Export PNGs and Create Icons', accelerator: 'Shift+CommandOrControl+I', click: () => util.captureAndCreateIcons() }
				]
			},
			{
				label: 'View',
